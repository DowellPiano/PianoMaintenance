...
EVENT_LABELS = {
    ...
    "platform.company_suspended": "Company suspended",
    "platform.company_reactivated": "Company reactivated",
    "platform.user_suspended": "User suspended",
    "platform.user_reactivated": "User reactivated",
    "platform.membership_admin_granted": "Admin access granted",
    "platform.membership_admin_removed": "Admin access removed",
