...
urlpatterns = [
    ...
    path(
        ...
        auth_views.PasswordResetView.as_view(
            template_name='registration/app_password_reset_form.html',
            email_template_name='registration/app_password_reset_email.html',
            subject_template_name='registration/app_password_reset_subject.txt',
    ...
    path(
        ...
        auth_views.PasswordResetDoneView.as_view(
            template_name='registration/app_password_reset_done.html',
        ),
    ...
    path(
        ...
        auth_views.PasswordResetConfirmView.as_view(
            template_name='registration/app_password_reset_confirm.html',
    ...
    path(
        ...
        auth_views.PasswordResetCompleteView.as_view(
            template_name='registration/app_password_reset_complete.html',
        ),
